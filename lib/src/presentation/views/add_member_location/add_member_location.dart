...
import 'package:assam_police_vdp/src/presentation/cubits/home/home_cubit.dart';
               ...
               BlocConsumer<UserMenuOptionCubit, UserMenuOptionState>(
                 ...
                 builder: (context, state) {
                  switch(state.runtimeType){
                    ...
                    case UserMenuOptionSuccessState : if(state.getUserMenuOptionResponse!.data!.isNotEmpty) {
                      return
                        Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      state.getUserMenuOptionResponse?.data![0]
                                          .vdpCommittee == 1 ? InkWell(
                                        onTap: () {
...
height: 200,width: 200,
                         ...
                         child: Text("Please Go back !",style: styleIbmPlexSansBold(size: 20, color: defaultColor),),)),
                     );
                    }
