...
class GoogleMapPickLocation extends StatefulWidget {
  final String? addressLat;
  final String? addressLng;

  GoogleMapPickLocation(
      {Key? key, required this.addressLat, required this.addressLng})
      : super(key: key);

  @override
  State<GoogleMapPickLocation> createState() =>
      _GoogleMapPickLocationState(addressLat, addressLng);
}

class _GoogleMapPickLocationState extends State<GoogleMapPickLocation> {
  _GoogleMapPickLocationState(this.addressLat, this.addressLng);
                ...
                child: Padding(
                  ...
                  child: ButtonThemeLarge(
                      ...
                      onClick: () {
                        ...
                        //           // if (position != null)
                        //           //   {
                        //           //     appRouter.push(GoogleMapPickLocationRoute(
                        //           //         addressLat: position
                        //           //             ?.latitude
                        //           //             .toString(),
                        //           //         addressLng: position
