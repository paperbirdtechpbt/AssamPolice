...
context.read<VdpMemberCubit>().getVdpMemberRoles();
  ...
  builder: (context, state) {
    return Container(
                      ...
                      BlocConsumer<VdpMemberCubit, VdpMemberState>(
                        listener: (context, state) {
                       if(state is AddVdpMemberSuccessState){
                        ...
                        builder: (context, state) {
                         switch(state.runtimeType){
                           case AddVdpMemberInitialState : return ButtonThemeLarge(
                               context: context,
                               color: defaultColor,
                               label: add,
                               onClick: () {
                           ...
                           case AddVdpMemberLoadingState : return Center(child: CircularProgressIndicator(color: defaultColor,),
                           );
                           case AddVdpMemberSuccessState : return ButtonThemeLarge(
                               context: context,
                               color: defaultColor,
                               label: add,
                               onClick: () {
